var testWidget9D60C1D7CBE74189917C11DFFDD456E6_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
/* harmony export */   _: () => (/* binding */ ReactWidget),
...
class ReactWidget extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
    ...
    render() {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "widget", style: { width, height } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "icon" }, icon),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "total__value center" }, formatCurrency(sumValue)),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "total__label center" }, "Today's Total Revenue"),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "center" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(TrendIcon, { uptrandColor: uptrandColor, downtrandColor: downtrandColor, value: values[3] / 100 })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "center" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "content" },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(InfoLine, { label: lables[1], value: values[1], delta: values[4] / 100 }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(InfoLine, { label: lables[2], value: values[2], delta: values[5] / 100 }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(InfoLine, { label: lables[3], value: values[3], delta: values[6] / 100 })))));
    }
}
function InfoLine({ label = 'No Data', value = 0, delta = 0 }) {
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "infoline" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "infoline__label" }, label),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "infoline__value" }, formatCurrency(value)),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(TrendIcon, { value: delta, small: true, className: "infoline__trand" })));
}
function TrendIcon({ value, className = '', small, uptrandColor, downtrandColor }) {
    ...
    const label = value
        ...
        : 'No data';
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { backgroundColor }, className: classes.reduce((acc, val) => `${acc} ${val}`, 'trend ') },
        value !== 0 && (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "trend__icon" }, value > 0 ? trendUp : trendDown)),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "trend__label" }, label)));
}
...
class WidgetSettings extends FormattingSettingsCard {
    uptrandColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.ColorPicker */ .z.sk({
        name: "uptrandColor",
        displayName: "Color",
        description: "The fill color of the uptand.",
        value: { value: "#5cff5c" }
    });
    downtrandColor = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .formattingSettings.ColorPicker */ .z.sk({
        name: "uptrandColor",
        displayName: "Color",
        description: "The fill color of the uptand.",
        value: { value: "#febdbd" }
    });
    name = "widget"; // circle card name should match circle object name in capabilities.json
    displayName = "Widget";
    show = true;
    slices = [this.uptrandColor, this.downtrandColor];
}
/**
...
/* harmony export */ });
/* harmony import */ var powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(674);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(833);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(540);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(338);
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(51);
...
class Visual {
    ...
    constructor(options) {
        this.root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_3__/* .createRoot */ .H)(options.element);
        this.el = react__WEBPACK_IMPORTED_MODULE_2__.createElement(_component__WEBPACK_IMPORTED_MODULE_4__/* .ReactWidget */ ._, {});
    ...
    clear() {
        _component__WEBPACK_IMPORTED_MODULE_4__/* .ReactWidget */ ._.update(_component__WEBPACK_IMPORTED_MODULE_4__/* .initialState */ .u);
    }
    getFormattingModel() {
    ...
    update(options) {
        ...
        if (dataView) {
            const numValuesArray = dataView?.table?.rows[0];
            const lables = dataView?.table?.columns.map((column) => column.displayName.replace(/Sum of /, ''));
            ...
            _component__WEBPACK_IMPORTED_MODULE_4__/* .ReactWidget */ ._.update({
...
// This entry need to be wrapped in an IIFE because it declares 'testWidget9D60C1D7CBE74189917C11DFFDD456E6_DEBUG' on top-level, which conflicts with the current library output.
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(912);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (testWidget9D60C1D7CBE74189917C11DFFDD456E6_DEBUG);

})();

testWidget9D60C1D7CBE74189917C11DFFDD456E6_DEBUG = __webpack_exports__;
/******/ })()
;
